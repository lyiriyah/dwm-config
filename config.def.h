...
static const unsigned int gappov =
    gappoh; /* vert outer gap between windows and screen edge */
...
static const int sidepad = vertpad;           /* horizontal padding of bar */
...
static const char *fonts[] = {"Hasklig:size=9"};
...
const char *spcmd1[] = {"st",      "-n", "spterm", "-t",
                        "scratch", "-g", "120x34", NULL};
...
static const BarRule barrules[] = {
    ...
    {'A', 0, BAR_ALIGN_RIGHT, width_systray, draw_systray, click_systray,
     "systray"},
...
static const Layout layouts[] = {
    ...
    {"TTT", bstack}, {"|M|", centeredmaster}, {"[M]", monocle},
...
static Key keys[] = {
    ...
    {MODKEY | ControlMask, XK_c, spawn, {.v = quitcmd}},
